...
\begin{enumerate}
    ...
    \item Architectural \& System-level Metrics: It evaluates not only the fragment of code but focuses primarily on a high level of abstraction. This group investigates system-wide characteristics, architectural behavior, dependencies, and coupling.	
