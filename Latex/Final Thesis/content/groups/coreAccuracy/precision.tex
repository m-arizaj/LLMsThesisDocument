...
\begin{longtable}{|p{0.15\textwidth}|p{0.40\textwidth}|p{0.35\textwidth}|}
    \caption{Variants of Precision in Software Engineering and LLM Evaluation} \label{tab:precision_variants} \\
    \hline
    \textbf{Variant} & \textbf{Description} & \textbf{Typical Use Cases} \\ \hline
    \endfirsthead
    
    \hline
    \textbf{Variant} & \textbf{Description} & \textbf{Typical Use Cases} (cont.) \\ \hline
    \endhead
