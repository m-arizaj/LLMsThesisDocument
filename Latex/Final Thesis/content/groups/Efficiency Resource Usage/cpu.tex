...
\begin{table}[h]
\centering
\caption{CPU Utilization Metrics in LLM Efficiency Benchmarks}
...
\begin{table}[h]
\centering
\caption{CPU Utilization and Throughput for LLM Inference on CPUs \cite{Ditto2024InferenceAcceleration}}
...
\begin{table}[h]
\centering
\caption{Relationship Between CPU Utilization and Other Efficiency Metrics}
\begin{tabularx}{\textwidth}{X X X}
\hline
