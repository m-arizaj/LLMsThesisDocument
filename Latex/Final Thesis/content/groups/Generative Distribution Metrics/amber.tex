...
\begin{itemize}
    \item Low $\text{CHAIR}$ values denote fewer hallucinated elements in generated descriptions.
    \item High $\text{F1}$ scores reflect reliable discriminative reasoning.
    \item The combined score encourages models that both see accurately and describe faithfully.
\end{itemize}

A high AMBER Score implies low hallucination frequency, accurate alignment between vision and language, and stable performance across task types and modalities.
